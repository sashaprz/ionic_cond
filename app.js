...
function App() {
  ...
  const handlePredict = async (composition) = {
    ...
    try {
      const response = await fetch('httplocalhost5000predict', {
        method 'POST',
  ...
  return (
    div
      ...
      div className=mt-8 flex justify-center
        {loading && p className=text-blue-600 text-lgPredicting...p}
        ...
        {prediction !== null && !loading && !error && (
          div
            ...
            div style={{ fontSize 56, color '#16a34a', marginBottom 12 }}✔️div
            ...
            div style={{
              ...
              {Number(prediction).toExponential(2).replace('e-', ' × 10⁻ ') +  '       Scm'}
            div
            button
              style={{
